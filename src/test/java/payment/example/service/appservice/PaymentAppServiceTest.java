...
class PaymentAppServiceTest {
    ...
    void PaymentAppService_결제_검증_성공() throws IamportResponseException, IOException {
        ...
        PaymentRequest request = new PaymentRequest(1004, test_imp_uid, "결제테스트", 1L);
    ...
    void PaymentAppService_결제_검증_실패__상품_이름이_일치하지_않음() {
        ...
        PaymentRequest request = new PaymentRequest(1004, test_imp_uid, "fakeTest", 1L);
    ...
    void PaymentAppService_결제_검증_실패__상품_가격이_일치하지_않음() {
        ...
        PaymentRequest request = new PaymentRequest(1003, test_imp_uid, "test", 1L);
